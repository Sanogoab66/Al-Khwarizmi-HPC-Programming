...
int64_t bind_c_solve_2d_linearconv_pyccel(int64_t n0_u, int64_t n1_u, double *u, int64_t n0_un, int64_t n1_un, double *un, int64_t nt, double dt, double dx, double dy, int64_t c);
...
PyObject *solve_2d_linearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = bind_c_solve_2d_linearconv_pyccel(nd_ndim(&u, 0), nd_ndim(&u, 1), nd_data(&u), nd_ndim(&un, 0), nd_ndim(&un, 1), nd_data(&un), nt, dt, dx, dy, c);
...
static PyMethodDef mod_45auzy0tntpt_45auzy0tntpt_methods[] = {
    {
...
static PyModuleDef_Slot mod_45auzy0tntpt_45auzy0tntpt_slots[] = {
...
static struct PyModuleDef mod_45auzy0tntpt_45auzy0tntpt_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_45auzy0tntpt_45auzy0tntpt",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_45auzy0tntpt_45auzy0tntpt_methods,
    mod_45auzy0tntpt_45auzy0tntpt_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_45auzy0tntpt_45auzy0tntpt(void)
{
    import_array();
    return PyModuleDef_Init(&mod_45auzy0tntpt_45auzy0tntpt_module);
}
