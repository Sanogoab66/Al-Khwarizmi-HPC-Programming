module mod_mc070qte6f35_mc070qte6f35
    ...
    do t = 0_i64, nt - 1_i64, 1_i64
      ...
      do i = 1_i64, row - 1_i64 - 1_i64, 1_i64
        do j = 1_i64, col - 1_i64 - 1_i64, 1_i64
          u(j, i) = un(j, i) + nu * (dt / dx ** 2_i64) * (un(j, i + &
                1_i64) - 2_i64 * un(j, i) + un(j, i - 1_i64)) + nu * ( &
                dt / dy ** 2_i64) * (un(j + 1_i64, i) - 2_i64 * un(j, i &
                ) + un(j - 1_i64, i))
        end do
      end do
    end do
...
end module mod_mc070qte6f35_mc070qte6f35
