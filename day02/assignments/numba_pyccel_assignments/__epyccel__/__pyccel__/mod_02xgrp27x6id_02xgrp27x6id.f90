module mod_02xgrp27x6id_02xgrp27x6id
    ...
    do t = 0_i64, nt - 1_i64, 1_i64
      ...
      do i = 1_i64, row - 1_i64 - 1_i64, 1_i64
        do j = 1_i64, col - 1_i64 - 1_i64, 1_i64
          u(j, i) = un(j, i) - dt / dx * un(j, i) * (un(j, i) - un(j, i &
                - 1_i64)) - dt / dx * vn(j, i) * (un(j, i) - un(j - &
                1_i64, i)) + nu * dt / dx ** 2_i64 * (un(j, i + 1_i64) &
                - 2_i64 * un(j, i) + un(j, i - 1_i64)) + nu * dt / dy &
                ** 2_i64 * (un(j + 1_i64, i) - 2_i64 * un(j, i) + un(j &
                - 1_i64, i))
          v(j, i) = vn(j, i) - dt / dx * un(j, i) * (vn(j, i) - vn(j, i &
                - 1_i64)) - dt / dx * vn(j, i) * (vn(j, i) - vn(j - &
                1_i64, i)) + nu * dt / dx ** 2_i64 * (vn(j, i + 1_i64) &
                - 2_i64 * vn(j, i) + vn(j, i - 1_i64)) + nu * dt / dy &
                ** 2_i64 * (vn(j + 1_i64, i) - 2_i64 * vn(j, i) + vn(j &
                - 1_i64, i))
        end do
      end do
    end do
...
end module mod_02xgrp27x6id_02xgrp27x6id
