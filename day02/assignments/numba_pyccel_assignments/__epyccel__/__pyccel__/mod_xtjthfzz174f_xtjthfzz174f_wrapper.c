...
PyObject *solve_2d_nonlinearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = bind_c_solve_2d_nonlinearconv_pyccel(nd_ndim(&u, 0), nd_ndim(&u, 1), nd_data(&u), nd_ndim(&un, 0), nd_ndim(&un, 1), nd_data(&un), nd_ndim(&v, 0), nd_ndim(&v, 1), nd_data(&v), nd_ndim(&vn, 0), nd_ndim(&vn, 1), nd_data(&vn), nt, dt, dx, dy, c);
...
static PyMethodDef mod_xtjthfzz174f_xtjthfzz174f_methods[] = {
    {
...
static PyModuleDef_Slot mod_xtjthfzz174f_xtjthfzz174f_slots[] = {
...
static struct PyModuleDef mod_xtjthfzz174f_xtjthfzz174f_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_xtjthfzz174f_xtjthfzz174f",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_xtjthfzz174f_xtjthfzz174f_methods,
    mod_xtjthfzz174f_xtjthfzz174f_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xtjthfzz174f_xtjthfzz174f(void)
{
    import_array();
    return PyModuleDef_Init(&mod_xtjthfzz174f_xtjthfzz174f_module);
}
