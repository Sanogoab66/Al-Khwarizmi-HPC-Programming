...
static PyMethodDef mod_4n10k32gzkrq_4n10k32gzkrq_methods[] = {
    {
...
static PyModuleDef_Slot mod_4n10k32gzkrq_4n10k32gzkrq_slots[] = {
...
static struct PyModuleDef mod_4n10k32gzkrq_4n10k32gzkrq_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_4n10k32gzkrq_4n10k32gzkrq",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_4n10k32gzkrq_4n10k32gzkrq_methods,
    mod_4n10k32gzkrq_4n10k32gzkrq_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4n10k32gzkrq_4n10k32gzkrq(void)
{
    import_array();
    return PyModuleDef_Init(&mod_4n10k32gzkrq_4n10k32gzkrq_module);
}
