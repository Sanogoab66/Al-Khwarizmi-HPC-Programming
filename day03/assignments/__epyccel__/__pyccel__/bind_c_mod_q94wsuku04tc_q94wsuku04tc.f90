module bind_c_mod_q94wsuku04tc_q94wsuku04tc

  use mod_q94wsuku04tc_q94wsuku04tc, only: solve_2d_nonlinearconv_pyccel
...
end module bind_c_mod_q94wsuku04tc_q94wsuku04tc
