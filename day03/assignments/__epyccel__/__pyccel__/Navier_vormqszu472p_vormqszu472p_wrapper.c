...
PyObject *build_up_b_numba_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O!OOO!O!OOO", kwlist, &PyArray_Type, &b_tmp, &rho_tmp, &dt_tmp, &PyArray_Type, &u_tmp, &PyArray_Type, &v_tmp, &dx_tmp, &dy_tmp, &num_tmp))
    {
        return NULL;
    }
    ...
    Out_0001 = build_up_b_numba(b, rho, dt, u, v, dx, dy, num);
...
PyObject *pressure_poisson_numba_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O!OOO!OO", kwlist, &PyArray_Type, &p_tmp, &dx_tmp, &dy_tmp, &PyArray_Type, &b_tmp, &nit_tmp, &num_tmp))
    {
        return NULL;
    }
    ...
    Out_0002 = pressure_poisson_numba(p, dx, dy, b, nit, num);
...
PyObject *cavity_flow_numba_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OO!O!OOOOOO!OOOO", kwlist, &nt_tmp, &PyArray_Type, &u_tmp, &PyArray_Type, &v_tmp, &dt_tmp, &nx_tmp, &ny_tmp, &dx_tmp, &dy_tmp, &PyArray_Type, &p_tmp, &rho_tmp, &nu_tmp, &nit_tmp, &num_tmp))
    {
        return NULL;
    }
    ...
    cavity_flow_numba(nt, u, v, dt, nx, ny, dx, dy, p, rho, nu, nit, num);
...
static PyMethodDef Navier_vormqszu472p_vormqszu472p_methods[] = {
    {
        "build_up_b_numba",
...
static PyModuleDef_Slot Navier_vormqszu472p_vormqszu472p_slots[] = {
...
static struct PyModuleDef Navier_vormqszu472p_vormqszu472p_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "Navier_vormqszu472p_vormqszu472p",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    Navier_vormqszu472p_vormqszu472p_methods,
    Navier_vormqszu472p_vormqszu472p_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_Navier_vormqszu472p_vormqszu472p(void)
{
    import_array();
    return PyModuleDef_Init(&Navier_vormqszu472p_vormqszu472p_module);
}
