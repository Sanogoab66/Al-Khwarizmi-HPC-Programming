module bind_c_mod_kod68wypzyys_kod68wypzyys

  use mod_kod68wypzyys_kod68wypzyys, only: solve_2d_nonlinearconv_pyccel
...
end module bind_c_mod_kod68wypzyys_kod68wypzyys
