...
static PyMethodDef Navier_myvu3k4gpnog_myvu3k4gpnog_methods[] = {
    {
        "build_up_b_numba",
...
static PyModuleDef_Slot Navier_myvu3k4gpnog_myvu3k4gpnog_slots[] = {
...
static struct PyModuleDef Navier_myvu3k4gpnog_myvu3k4gpnog_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "Navier_myvu3k4gpnog_myvu3k4gpnog",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    Navier_myvu3k4gpnog_myvu3k4gpnog_methods,
    Navier_myvu3k4gpnog_myvu3k4gpnog_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_Navier_myvu3k4gpnog_myvu3k4gpnog(void)
{
    import_array();
    return PyModuleDef_Init(&Navier_myvu3k4gpnog_myvu3k4gpnog_module);
}
