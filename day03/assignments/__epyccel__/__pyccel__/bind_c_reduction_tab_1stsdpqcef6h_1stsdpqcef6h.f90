module bind_c_reduction_tab_1stsdpqcef6h_1stsdpqcef6h

  use reduction_tab_1stsdpqcef6h_1stsdpqcef6h, only: reduction
  use reduction_tab_1stsdpqcef6h_1stsdpqcef6h, only: threads_num
  use reduction_tab_1stsdpqcef6h_1stsdpqcef6h, only: initialize_table
...
end module bind_c_reduction_tab_1stsdpqcef6h_1stsdpqcef6h
