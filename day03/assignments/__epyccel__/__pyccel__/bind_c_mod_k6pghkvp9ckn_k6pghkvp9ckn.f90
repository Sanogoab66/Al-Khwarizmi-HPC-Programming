module bind_c_mod_k6pghkvp9ckn_k6pghkvp9ckn

  use mod_k6pghkvp9ckn_k6pghkvp9ckn, only: solve_2d_nonlinearconv_pyccel
...
end module bind_c_mod_k6pghkvp9ckn_k6pghkvp9ckn
