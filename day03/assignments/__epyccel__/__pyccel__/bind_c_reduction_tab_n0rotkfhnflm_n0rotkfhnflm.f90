module bind_c_reduction_tab_n0rotkfhnflm_n0rotkfhnflm

  use reduction_tab_n0rotkfhnflm_n0rotkfhnflm, only: threads_num
  use reduction_tab_n0rotkfhnflm_n0rotkfhnflm, only: reduction
  use reduction_tab_n0rotkfhnflm_n0rotkfhnflm, only: initialize_table
...
end module bind_c_reduction_tab_n0rotkfhnflm_n0rotkfhnflm
