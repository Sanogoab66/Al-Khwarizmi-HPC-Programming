module bind_c_reduction_tab_oyby34mlwnwl_oyby34mlwnwl

  use reduction_tab_oyby34mlwnwl_oyby34mlwnwl, only: threads_num
  use reduction_tab_oyby34mlwnwl_oyby34mlwnwl, only: initialize_table
  use reduction_tab_oyby34mlwnwl_oyby34mlwnwl, only: reduction
...
end module bind_c_reduction_tab_oyby34mlwnwl_oyby34mlwnwl
