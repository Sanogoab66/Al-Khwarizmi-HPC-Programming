module bind_c_mod_sded15arr4sz_sded15arr4sz

  use mod_sded15arr4sz_sded15arr4sz, only: solve_2d_nonlinearconv_pyccel
...
end module bind_c_mod_sded15arr4sz_sded15arr4sz
