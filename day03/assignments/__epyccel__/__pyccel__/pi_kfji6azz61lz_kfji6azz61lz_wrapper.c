...
static PyMethodDef pi_kfji6azz61lz_kfji6azz61lz_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_kfji6azz61lz_kfji6azz61lz_slots[] = {
...
static struct PyModuleDef pi_kfji6azz61lz_kfji6azz61lz_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_kfji6azz61lz_kfji6azz61lz",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_kfji6azz61lz_kfji6azz61lz_methods,
    pi_kfji6azz61lz_kfji6azz61lz_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_kfji6azz61lz_kfji6azz61lz(void)
{
    import_array();
    return PyModuleDef_Init(&pi_kfji6azz61lz_kfji6azz61lz_module);
}
