module bind_c_reduction_tab_xuhicveu2qx0_xuhicveu2qx0

  use reduction_tab_xuhicveu2qx0_xuhicveu2qx0, only: initialize_table
  use reduction_tab_xuhicveu2qx0_xuhicveu2qx0, only: reduction
  use reduction_tab_xuhicveu2qx0_xuhicveu2qx0, only: threads_num
...
end module bind_c_reduction_tab_xuhicveu2qx0_xuhicveu2qx0
