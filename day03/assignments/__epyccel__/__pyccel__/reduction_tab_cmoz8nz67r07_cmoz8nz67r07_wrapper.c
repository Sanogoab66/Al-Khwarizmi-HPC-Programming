...
void bind_c_threads_num(int64_t num);
...
PyObject *threads_num_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O", kwlist, &num_tmp))
    {
        return NULL;
    }
...
static PyMethodDef reduction_tab_cmoz8nz67r07_cmoz8nz67r07_methods[] = {
    {
        "threads_num",
...
static PyModuleDef_Slot reduction_tab_cmoz8nz67r07_cmoz8nz67r07_slots[] = {
...
static struct PyModuleDef reduction_tab_cmoz8nz67r07_cmoz8nz67r07_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "reduction_tab_cmoz8nz67r07_cmoz8nz67r07",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    reduction_tab_cmoz8nz67r07_cmoz8nz67r07_methods,
    reduction_tab_cmoz8nz67r07_cmoz8nz67r07_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_reduction_tab_cmoz8nz67r07_cmoz8nz67r07(void)
{
    import_array();
    return PyModuleDef_Init(&reduction_tab_cmoz8nz67r07_cmoz8nz67r07_module);
}
