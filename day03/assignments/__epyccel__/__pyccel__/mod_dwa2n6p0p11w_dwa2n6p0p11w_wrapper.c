...
static PyMethodDef mod_dwa2n6p0p11w_dwa2n6p0p11w_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_dwa2n6p0p11w_dwa2n6p0p11w_slots[] = {
...
static struct PyModuleDef mod_dwa2n6p0p11w_dwa2n6p0p11w_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_dwa2n6p0p11w_dwa2n6p0p11w",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_dwa2n6p0p11w_dwa2n6p0p11w_methods,
    mod_dwa2n6p0p11w_dwa2n6p0p11w_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dwa2n6p0p11w_dwa2n6p0p11w(void)
{
    import_array();
    return PyModuleDef_Init(&mod_dwa2n6p0p11w_dwa2n6p0p11w_module);
}
